...
export default class Schedule extends Array<SchedulePart> implements ScheduleData {

    constructor(scheduleData: ScheduleData) {
        const scheduleParts: SchedulePart[] = scheduleData.map(schedulePartData => new SchedulePart(schedulePartData));
        super(...scheduleParts);
    }

    static fromRawScheduleData(
